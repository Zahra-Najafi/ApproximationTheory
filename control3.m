...
%disp(tab);
T = array2table(tab,...
'VariableNames',{'t','Analyticalsolution','ApproximationSolutionByHLP','Error' });
disp(T);
disp('=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o');
if N==1
    integ=x(1)*integral(@(t)(t*0+1),0,1)+e(1);
    for i=2:m+1
        integ=(c(i)*integral(matlabFunction(px{i}),0,1)+e(i))+integ;
    end
    disp('integral is :');
    disp(integ);
else
    integ=0;
    for i=1:1:N
        integ=c(i)*integral(@(t)(t*0+1),0,1)+e(i)+integ;
    end
    for i=N+1:1:(M+1)*N
        integ=((c(i)*integral(matlabFunction(px{i}),0,1))+e(i))+integ;
    end
